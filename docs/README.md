...
- [Entrenamiento y datos](./entrenamiento-y-datos.md): backends TensorFlow.js, datasets públicos, formato CSV, configuración de entrenamiento y exportación del modelo.
...
4. Abrir el panel `Train`, cargar un dataset público, generar datos de ejemplo o pegar CSV.
5. Elegir el backend TensorFlow.js si hace falta.
6. Construir el modelo, entrenarlo y exportar el JSON o el código TypeScript.

## Tecnologías

- Angular 21 con componentes standalone y signals.
- TensorFlow.js con backends WebGPU, WebGL, WASM y CPU con fallback automático.
- Canvas HTML/CSS con SVG para dibujar conexiones.
- Persistencia local mediante `localStorage`.
- Tooltips custom reutilizables para controles, capas y parámetros.
